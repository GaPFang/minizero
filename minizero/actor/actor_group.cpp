...
void ThreadSharedData::outputGame(const std::shared_ptr<BaseActor>& actor)
{
    ...
    oss << "SelfPlay "
        ...
        << actor->getEnvironment().getAverageIllegalActionRate() << " "                                                    // illegal action rate
        << actor->getEnvironment().getAverageIllegalPlayerRate() << " "                                                    // illegal player rate
        << actor->getEnvironment().getAverageIllegalBothRate() << " "                                                      // illegal both rate
